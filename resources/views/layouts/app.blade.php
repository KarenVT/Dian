                    ...
                    <div class="flex-1 h-0 overflow-y-auto pt-2 pb-4">
                        <div class="px-2 space-y-1">
                            ...
                            @can('sell')
                                ...
                                <a href="{{ route('customers.index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-100 {{ request()->routeIs('customers.index') ? 'bg-gray-100' : '' }}">
                                    Mis Clientes
                                </a>
                                @else
                                <span class="block px-3 py-2 rounded-md text-base font-medium text-gray-400">
                        ...
                        @can('sell')
                            ...
                            @endif
                                ...
                                <a href="{{ route('customers.index') }}" class="group flex items-center px-2 py-2 rounded-md text-sm font-medium text-gray-900 hover:bg-indigo-50 hover:text-indigo-700 {{ request()->routeIs('customers.index') ? 'bg-indigo-50 text-indigo-700' : '' }}">
                                    <svg class="mr-3 h-5 w-5 text-gray-500 group-hover:text-indigo-600 {{ request()->routeIs('customers.index') ? 'text-indigo-600' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
