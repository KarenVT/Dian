                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="document_type" name="document_type" x-data="{ type: '{{ old('document_type', 'CC') }}' }" x-model="type" x-on:change="setupIdMask(type)" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
